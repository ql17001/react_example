...
export default function Home() {
  ...
  return (
    <main>
      ...
      <button className='botonEliminar' onClick={()=>persistAuthentication({token:'HolaMundo'})}>Persistir</button>

      <button className='botonEliminar' onClick={()=>console.log(retrieveAuthentication())}>Traer</button>

      <button className='botonEliminar' onClick={()=>deleteAuthentication()}>Borrar</button>
